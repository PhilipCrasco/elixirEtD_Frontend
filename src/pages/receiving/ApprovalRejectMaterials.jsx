import { Box, Flex, Heading, HStack, Input, InputGroup, InputLeftElement, Skeleton, Stack, Table, Tbody, Text, Th, Thead, Tr, VStack,
  useDisclosure,
  Popover,
  PopoverTrigger,
  PopoverContent,
...
const ApprovalRejectMaterials = () => {
  ...
  const { isCancelModalOpen, onOpen: openCancelModal, onClose: closeCancel } = useDisclosure()
  ...
  return (
    <Flex color="fontColor" h="auto" w="full" borderRadius="md" flexDirection="column" bg="background" boxShadow="md">
      <Flex bg="buttonColor" borderRadius="10px 10px 0px 0px" w="25%" pl={2}>
        ...
        <Text p={2} fontWeight="semibold"  fontSize="12px" color="white">Warehouse Receiving Confirm Reject</Text>
      </Flex>
          ...
          <ModalBody>
            {
              !viewData ? (
                ...
                <Thead bg="primary">
                  <Tr>
                    <Th color="white" fontSize="9px">PO No.</Th>
                    <Th color="white" fontSize="9px">Approved Date</Th>
                    <Th color="white" fontSize="9px">PR No.</Th>
